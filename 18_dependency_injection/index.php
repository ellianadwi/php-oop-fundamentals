...
echo '<iframe width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;geocode=&amp;q=' . rawurlencode($address->street . '' . $address->city) . '&amp;output=embed"></iframe>';
