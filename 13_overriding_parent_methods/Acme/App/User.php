...
class User {
    ...
    /**
     * All propertes that can be set dirctly
     * @var array
     */
     ...
     * @var array
     */
    protected $acccessible = array('email', 'password');
    ...
    /**
     * Directly set inaceessible but existing properties, if in $this->fillable array
     * @param string $name
     * @param mixed $value
     * @return void
     */
